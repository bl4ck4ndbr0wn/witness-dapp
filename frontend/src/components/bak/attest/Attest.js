...
class AtestClaim extends Component {
  state = {
    witnesses: [],
    claim: ""
  };
  ...
  attestClaim = e => {
    ...
    this.props.attestClaim({ ...this.state, claim_id: id });
...
AtestClaim.propTypes = {
  attestClaim: PropTypes.func.isRequired
};

export default AtestClaim;
